...
**Хакер** 
```xml
Изгражда информационната система и подсигурява нейният стабилен перформънс и инфраструктура, пише на софтуер за автоматизация и защита, на сървърире свързани с въпросната инфраструктура! 
